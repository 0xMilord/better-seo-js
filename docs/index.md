...
| **Copy-paste**   | [Recipes](./recipes/index.md) — layout merge, rules, OG, icons, MDX frontmatter, React                          |
| **Reference**    | [API overview](./api/index.md) (incl. **compiler**), [CLI overview](./cli/index.md) → [commands](./commands.md) |

...
- **@better-seo/cli**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.

### Bug Fixes

- **@better-seo/core**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
- **@better-seo/next**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
- **@better-seo/react**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
- **@better-seo/assets**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
- **@better-seo/crawl**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
- **@better-seo/compiler**: Comprehensive audit fixes (v0.2.0): - **Removed "AST-first" language** — scan/add/fix/codemods use pattern-based (regex) detection, not AST. Updated all internal docs and source file headers. - **Implemented `template switch` (L10)** — merges industry preset with existing `better-seo.config.ts` non-destructively. Supports `--dry-run`, `--out`, auto-detects existing config. - **Fixed `package-lock.json`** — regenerated without optional `@emnapi` deps that caused `npm ci` failures on CI. - **Updated PROGRESS.md** — reflects static HTML docs site (Nextra app removed), marks P4 (packaged plugins) as Ongoing. - **Added 13 generateSplash tests** — covers all 9 iOS/iPadOS splash sizes, PNG magic bytes, dimension validation, error handling, `isLightColor` utility. - **Added 7 CLI tests** — `runInit`, `runDoctor`, `runMigrate` now tested for framework detection, JSON output, migration guidance. - **Enhanced `snapshot compare`** — structured diff output shows added/removed tags with readable labels instead of just "files differ". - **Added Pages Router recipe (NX2)** — full `_app.tsx` + `BetterSEOHelmet` integration guide. - **Added i18n/Hreflang recipe (NX7)** — per-locale pages, layout-level alternates, sitemap hreflang entries, merge strategy. - **Total tests: 367** (up from 354) across 7 packages.
